...
def training(gs_type: str, 
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        if gaussians.use_img_feats == False:
            train_idx = -1
        ...
        #     print("remove right-side pixels")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_iterations", nargs="+", type=int, default=[7_000, 20_000, 30_000, 50_000, 100_000])
    parser.add_argument("--save_iterations", nargs="+", type=int, default=[7_000, 20_000, 30_000, 50_000, 100_000])
    ...
    training(args.gs_type, args.appearance_modeling,
